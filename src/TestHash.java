...
public class TestHash {
    ...
    public static void main(String [] args) {
   	...
   	HashTable<Integer> intHashtable = new HashTable<Integer>(7, 0.8, 3);
   	intHashtable.dump(sysOut);
   	intHashtable.insert(1);
   	intHashtable.insert(2);
   	intHashtable.insert(3);
   	intHashtable.insert(4);
   	intHashtable.insert(8);
   	intHashtable.dump(sysOut);
   	intHashtable.displayStats(sysOut);
   	intHashtable.insert(2);
   	intHashtable.insert(2);
   	intHashtable.dump(sysOut);
   	intHashtable.displayStats(sysOut);
